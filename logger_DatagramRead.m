function [Bin, newArray, GPS] = logger_DatagramRead(DataType, Datagram, ThreadID)
    ...
    switch DataType
        case 40;       GPS             = Fcn_GPSRead(Datagram);
        case {67, 68}; [Bin, newArray] = Fcn_SpectralRead(DataType, Datagram, ThreadID);
    end

end

function [Bin, newArray, GPS] = Fcn_GPSRead(Datagram)
...
function [Bin, newArray] = Fcn_SpectralRead(DataType, Datagram, ThreadID)
    ...
    switch DataType
        ...
        case 68
            ...
            newArray = TraceData./2 + OFFSET - 127.5;
    end
